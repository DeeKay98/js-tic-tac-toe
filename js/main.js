...
// console.log(checkGameStatus(["X", "O", "X", "X", "O", "X", "O", "X", "X"]));
...
function handleElementClick(cell, index) {
  const isClick =
...
function initCellElementList() {
  ...
  cellElementList.forEach((cell, index) => {
    cell.addEventListener("click", () => handleElementClick(cell, index));
  });
}
